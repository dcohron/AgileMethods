...
# CodeOutputProject#2.txt     Output to terminal from this program and input file above

# Honor Code Statement
# I pledge on my honor that I have not given or received any 
# unauthorized assistance on this assignment/examination. 
# I further pledge that I have not copied any material from 
# a book, article, the Internet or any other source except 
# where I have expressly cited the source.
# Signature: David N. Cohron         Date: 30 May 2017
